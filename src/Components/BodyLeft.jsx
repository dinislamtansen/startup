  ...
  return (
    ...
    <div className=' pt-20  pl-10'>
     <p className=' text-gray-300 text-2xl'>Welcome to my world</p><br />
      ...
      <h1></h1>
      <Animate/><br /><br />
      <p className=" text-emerald-300">I am a professional web developer with 5 years of experience.I have experiences in HTML5, CSS, JAVASCRIPT, BOOTSTRAP, TAILWINDCSS, REACT, MONGODB, EXPRESS JS</p>
    </div>
